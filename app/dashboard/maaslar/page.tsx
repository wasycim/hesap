      ...
      tables: [
        {
          ...
          rows: [
            ...
            ["Mesai Kazanç", `+${formatMoney(item.mesaiKazanc)} TL`],
            ...(item.corbaTotal > 0 ? [["Çorba Kazanç", `+${formatMoney(item.corbaTotal)} TL`]] : []),
            ["TOPLAM KAZANÇ (GELİR)", `+${formatMoney(item.toplamKazanc)} TL`],
          ],
        },
        {
        ...
        {
          title: "Mesailer ve Hakedişler Detayı (Gelir)",
          type: "gelir",
          headers: ["Tarih", "Açıklama", "Tutar"],
          firstColumnWidth: "28%",
