...
export const ON_DORT_NO_HESAP_DEFAULT_COLUMNS: TableColumnSetting[] = [
  { table_type: "on_dort_no_hesap", column_key: "kasadan", label: "KASADAN", color: "bg-orange-500", sort_order: 0, aktif: true, builtin: true },
  { table_type: "on_dort_no_hesap", column_key: "pamukkale_turizm", label: "PAMUKKALE TURİZM", color: "bg-yellow-500", sort_order: 1, aktif: true, builtin: true },
  { table_type: "on_dort_no_hesap", column_key: "anadolu_turizm", label: "ANADOLU TURİZM", color: "bg-yellow-500", sort_order: 2, aktif: true, builtin: true },
  { table_type: "on_dort_no_hesap", column_key: "inegol_seyahat", label: "İNEGÖL SEYAHAT", color: "bg-yellow-500", sort_order: 3, aktif: true, builtin: true },
  { table_type: "on_dort_no_hesap", column_key: "on_dort_no_giden", label: "14 NO GİDEN", color: "bg-orange-500", sort_order: 4, aktif: true, builtin: true },
  { table_type: "on_dort_no_hesap", column_key: "diger_kasa", label: "DİĞER - KASA", color: "bg-purple-600", sort_order: 5, aktif: true, builtin: true },
  { table_type: "on_dort_no_hesap", column_key: "gelir_toplam", label: "TOPLAM", color: "bg-green-600", sort_order: 6, aktif: true, builtin: true },
  { table_type: "on_dort_no_hesap", column_key: "kredi_karti_14_no", label: "14 NO KREDİ KARTI", color: "bg-blue-500", sort_order: 7, aktif: true, builtin: true },
  { table_type: "on_dort_no_hesap", column_key: "teslim", label: "TESLİM", color: "bg-blue-500", sort_order: 8, aktif: true, builtin: true },
