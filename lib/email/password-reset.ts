                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                  <tr>
                    <td style="width:58px;vertical-align:top;">
                      <table role="presentation" width="52" height="52" cellspacing="0" cellpadding="0" style="width:52px;height:52px;border-collapse:separate;border-radius:14px;background:#111827;">
                        <tr>
